...
操作方法については、[Gotepad ユーザーマニュアル](docs/user_manual.ja.md)を参照してください。
...
- 更新確認：現在のプラットフォームと正式版／テスト版の区分に従って GitHub Release を確認し、適用できる最新 5 バージョンまでの更新内容を表示します。GitHub またはクラウドドライブのダウンロードページをシステムブラウザーで開けます。
